...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .ai-label { display: inline-flex; margin-top: 8px; border-radius: 999px; padding: 4px 8px; background: rgba(245, 200, 66, .18); color: ${secondary}; font-size: 10px; font-weight: 800; }
