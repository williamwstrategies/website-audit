...
const firstMonthDiscountSequenceSteps = [
  {
    key: 'first_month_discount_retired_day_0',
    delayMinutes: 0,
    campaign: FIRST_MONTH_DISCOUNT_CAMPAIGN_KEY,
    subject: 'PitchProof plan reminder',
    previewText: 'The previous first-month discount campaign has been retired.',
    headline: 'The first-month discount campaign is retired.',
    intro: 'PitchProof no longer sends the first-month discount campaign.',
    paragraphs: [
  ...
  {
    key: 'first_month_discount_retired_day_3',
    delayMinutes: 4320,
    campaign: FIRST_MONTH_DISCOUNT_CAMPAIGN_KEY,
  ...
  {
    key: 'first_month_discount_retired_day_7',
    delayMinutes: 10080,
    campaign: FIRST_MONTH_DISCOUNT_CAMPAIGN_KEY,
    subject: 'PitchProof plan reminder',
    previewText: 'The previous first-month discount campaign has been retired.',
    ...
    <div style="margin:0;padding:28px;background:#f5f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1d1d1f;">
      ...
      <div style="max-width:660px;margin:0 auto;background:#ffffff;border:1px solid #e5e5ea;border-radius:18px;overflow:hidden;box-shadow:0 18px 48px rgba(0,0,0,0.08);">
        <div style="padding:28px 30px;border-bottom:1px solid #ececf0;">
          ...
          <p style="margin:12px 0 0;font-size:14px;line-height:1.55;color:#6e6e73;">This campaign is no longer active.</p>
        </div>
        ...
        <div style="padding:0 30px 30px;">
          ...
          ${bulletHtml}
          <a href="${htmlEscape(accountLink)}" style="display:inline-block;padding:13px 18px;border-radius:12px;background:#f5c842;color:#1d1d1f;text-decoration:none;font-weight:800;">${htmlEscape(step.cta)}</a>
          <p style="margin:22px 0 0;font-size:13px;line-height:1.6;color:#6e6e73;">If you are already subscribed, you can ignore this email.</p>
...
async function runFirstMonthDiscountSequenceBroadcast(options = {}) {
  ...
  return {
    ...
    dryRun,
    disabled: true,
    message: 'First-month discount campaign is disabled.',
    campaign,
    step: '',
    subject: '',
    cta_url: billingUrl(),
    ...
    skipped: { campaign_disabled: true },
    due_steps: [],
    not_due_steps: [],
    sample_recipients: [],
    deliveries: [],
