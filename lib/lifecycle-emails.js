...
const sevenDayTrialBroadcastStep = {
  ...
  previewText: 'Start your 7-day PitchProof trial with $1 activation and scan a real prospect this week.',
  headline: 'Your 7-day PitchProof trial is available.',
  ...
  return `
    <div style="margin:0;padding:28px;background:#f5f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1d1d1f;">
      ...
      <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e5ea;border-radius:18px;overflow:hidden;box-shadow:0 18px 48px rgba(0,0,0,0.08);">
        ...
        <div style="padding:28px 30px;">
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">${greeting}</p>
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">We've reopened the <strong style="color:#1d1d1f;">7-day PitchProof trial</strong> on your account.</p>
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">Stripe charges $1 today to activate the trial, and monthly billing starts after the trial unless you cancel.</p>
...
function sevenDayTrialEmailText({ user, profile, step }) {
  ...
  return [
    name ? `Hi ${name},` : 'Hi,',
    '',
    "We've reopened the 7-day PitchProof trial on your account.",
    '',
    'Stripe charges $1 today to activate the trial, and monthly billing starts after the trial unless you cancel.',
    '',
