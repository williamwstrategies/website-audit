...
const sevenDayTrialBroadcastStep = {
  ...
  previewText: 'Start your 7-day PitchProof trial and scan a real prospect this week.',
  ...
  return `
    <div style="margin:0;padding:28px;background:#f5f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1d1d1f;">
      ...
      <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e5ea;border-radius:18px;overflow:hidden;box-shadow:0 18px 48px rgba(0,0,0,0.08);">
        ...
        <div style="padding:28px 30px;">
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">${greeting}</p>
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">We've reopened the <strong style="color:#1d1d1f;">7-day free trial</strong> on your PitchProof account.</p>
          <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:#3d3d43;">Stripe collects your payment method at checkout, but billing starts after the trial unless you cancel.</p>
...
function sevenDayTrialEmailText({ user, profile, step }) {
  ...
  return [
    name ? `Hi ${name},` : 'Hi,',
    '',
    "We've reopened the 7-day free trial on your PitchProof account.",
    '',
    'Stripe collects your payment method at checkout, but billing starts after the trial unless you cancel.',
    '',
